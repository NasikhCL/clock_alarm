...
/*to change the theme between dark theme and light theme 
and also modify the change theme button image */
var isOn=false;
function changeBackground() {
    var darkLight =document.querySelector("#clock-full-body")
    var changeButton = document.querySelector("#change")


    if(!isOn){
        darkLight.classList.add("change-to-black")
        darkLight.classList.remove("change-to-white")
        ...
        darkLight.classList.add("change-to-white")
        darkLight.classList.remove("change-to-black")
